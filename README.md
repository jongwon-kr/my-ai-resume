...
| **현재 상태**              | MVP + 한국 시장 맞춤 + 포트폴리오·RAG 기반까지 구현, 프로덕션 배포 가능 수준  |
...
4. 우하단 버튼으로 **AI 채팅 창** 열기 — 스트리밍 답변, 추천 질문 3개, 답변이 어려울 때 **직접 문의** 폼
...
- **FAQ 우선 응답** — 등록한 예상 질문은 키워드 + 임베딩 의미 매칭(유사도 0.72)으로 Gemini 호출 없이 즉답
