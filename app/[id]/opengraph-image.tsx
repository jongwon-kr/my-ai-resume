...
export default async function OpenGraphImage({ params }: OpenGraphImageProps) {
  ...
  const pretendardMediumUrl = "https://cdn.jsdelivr.net/gh/orioncactus/pretendard@v1.3.9/packages/pretendard/dist/public/static/Pretendard-Medium.ttf";
  const pretendardBoldUrl = "https://cdn.jsdelivr.net/gh/orioncactus/pretendard@v1.3.9/packages/pretendard/dist/public/static/Pretendard-Bold.ttf";
    ...
    (
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          {profile.intro ? (
            <div style={{ fontSize: 28, opacity: 0.8, maxWidth: 900, lineHeight: 1.4 }}>
              {profile.intro.slice(0, 120)}{profile.intro.length > 120 ? "..." : ""}
            </div>
          ) : null}
        </div>
