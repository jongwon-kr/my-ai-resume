...
Cursor Chat/Agent 이력은 PC 로컬 저장입니다. 대화 UI까지 옮기려면 [cursaves](https://github.com/Callum-Ward/cursaves) 등 서드파티 도구를 사용하세요. **작업 맥락 공유는 Git 문서(07, 08)가 핵심**입니다.
